module utils_omp
   ...
   interface omp_target_alloc_f
      module procedure omp_target_alloc_f_int_1,  omp_target_alloc_f_int_2,  omp_target_alloc_f_int_3,  &
                       omp_target_alloc_f_int_4,  omp_target_alloc_f_int_5,  omp_target_alloc_f_int_6,  &
                       omp_target_alloc_f_int_7, &
                       omp_target_alloc_f_real_1, omp_target_alloc_f_real_2, omp_target_alloc_f_real_3, &
   ...
   interface omp_target_free_f
      module procedure omp_target_free_f_int_1, omp_target_free_f_int_2, omp_target_free_f_int_3, &
                       omp_target_free_f_int_4, omp_target_free_f_int_5, omp_target_free_f_int_6, &
                       omp_target_free_f_int_7, &
                       omp_target_free_f_real_1, omp_target_free_f_real_2, omp_target_free_f_real_3, &
                       omp_target_free_f_real_4, omp_target_free_f_real_5, omp_target_free_f_real_6, &
                       omp_target_free_f_real_7
...
contains
      ...
      function omp_target_memcpy_f_int(fptr_dst, fptr_src, dst_off, src_off, &
         ...
         omp_target_memcpy_f_int = int(omp_target_memcpy(cptr_dst, cptr_src, total_dim, omp_dst_offset, omp_src_offset, &
      ...
      function omp_target_memcpy_f_real(fptr_dst, fptr_src, dst_off, src_off, &
         ...
         omp_target_memcpy_f_real = int(omp_target_memcpy(cptr_dst, cptr_src, total_dim, omp_dst_offset, omp_src_offset, &
            omp_dst_device, omp_src_device), ikind)
