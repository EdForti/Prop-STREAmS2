...
x_e          = 30*D       # Activation point
Lx           = 60*D     # Length after activation point where deltax = deltax_ratio * deltax_e
alpha        = 0.25        # deltax increase from -inf to 0 of alpha*deltax_e
#deltax_e     = (1.3*D/NpD)*(1+alpha) # deltax at activation point
deltax_e     = 120e-6*3  # deltax at activation point
deltax_ratio = 8         # deltax after Lx from activation / deltax at activation
