...
real(rkind), dimension(:,:,:), allocatable :: wstat,wstatb,wstat_budget
real(rkind), dimension(:,:), allocatable   :: wstattemp,vtemp,statprop
...
integer                                    :: save_plot3d,save_budget_plot3d
integer                                    :: io_type_w
integer                                    :: mpi_split_x
