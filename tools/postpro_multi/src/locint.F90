...
!
      ...
      !}}}
      !{{{ localizzaz_carroarmato
      subroutine localizzaz_carroarmato(i1,i2,j1,j2, &
...
!
      ...
      !}}}
      !{{{ localizzaz_tank
      subroutine localizzaz_tank(i1,i2,j1,j2, &
...
!     nuovi
      call localizzaz_carroarmato(i1,i2,j1,j2, &
...
!
      if ((ierr.eq.1).and.(iprint.eq.1)) then
       ...
       print*,  xcg(:,ii,jj  ), xcg(:,ii+1,jj  )
       print*, '================================'
       print*, 'qualquadra non cosa, point inside the domain'
      endif
!
!     check
