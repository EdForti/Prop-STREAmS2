...
ifeq (${CANTERA},"yes")
    ...
    TP_MODS := $(TP_MODS) third-party/cantera_utils/cantera_utils.o third-party/cantera_utils/cantera_utils_cxx.o
else
    TP_MODS := $(TP_MODS) third-party/cantera_utils/cantera_utils_dummy.o third-party/cantera_utils/cantera_dummy.o
endif
ifeq (${CGAL},"yes")
